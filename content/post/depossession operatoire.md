---
title: Savoir sans faire. Faire sans savoir.
date: 2026-01-13
...
Début janvier 2026, j'ai publié une note sur [la prolétarisation du droit à l'ère de l'ia.](https://reflexions.florianernotte.be/post/proletarisation-droit/). Suite à cela, j'ai pu avoir quelques échanges forts intéressants avec d'autres avocats qui ont nourris ma réflexions sur le sujet. 
...
Avant d'aborder le cœur de cette note, je dois soulever une contradiction qui pourrait sauter aux yeux des techniciens . On ne cesse de le dire, un LLM n'a pas de connaissance. Il exécute des opérations. Ce ne sont que des machines qui prédisent des séquences de signes probables ([A. Alombert, Panser la bêtise artificielle]( [http://journals.openedition.org/appareil/6979; DOI](http://journals.openedition.org/appareil/6979;%20DOI):  [https://doi.org/10.4000/appareil.6979](https://doi.org/10.4000/appareil.6979))) ou encore des machines qui modulent, déplacent, hiérarchisent, ordonnent la position de signes a-signifiants ([M. Corteel, Ni Dieu, Ni IA, Une philosophie sceptique de l'intelligence artificielle](https://www.editionsladecouverte.fr/ni_dieu_ni_ia-9782348084614), La Découverte, 2025, p.59).
...
Aujourd'hui, même si techniquement le LLM ne "sait" pas, socialement et économiquement, il est de plus en plus traité comme s'il savait. D'ailleurs, l'image du perroquet stochastique n'est plus immédiatement convoquée lorsqu'on veut parler des LLMs (voir par exemple [ici](https://antirez.com/news/157) et [là](https://arxiv.org/html/2505.23323v1)).
...
D'une certaine manière, ce constat est pertinent. L'accessibilité est augmentée et l'IAG permet de réaliser une série de choses dont nous n'étions pas nécessairement capable (voir sur le sujet : [L'IA est une transformation](https://reflexions.florianernotte.be/post/ia-transformation/)). 
...
>Les rétentions tertiaires constituent le milieu dans lequel nos rétentions secondaires opèrent une sélection de nos rétentions primaires. ([Christian Fauré](https://www.christian-faure.net/2006/05/10/a-propos-de-la-rtention/))
...
[Chatonsky a considéré la place de l'IAG au sein d'une nouvelle rétention : la rétention quaternaire. ](https://chatonsky.net/lecture-ecriture/) en la décrivant comme celle qui porte sur les gestes et habitudes attentionnelles eux-mêmes.
...
Chatonsky propose aussi le concept de [distension](https://chatonsky.net/retention-distention/) pour qualifier "le traitement statistique des rétentions" effectué par cette quatrième mémoire. 
...
Si l'on revient à la notion de pharmakon ([évoquée ici](https://reflexions.florianernotte.be/post/ethique-conformit%C3%A9/)), la technique étant un remède tout en étant un poison, il faut mettre en œuvre des pratiques thérapeutiques comme le préconisait Stiegler. 

Je pourrais reformuler son propos lors [d'une intervention retranscrite ici](https://abracadabibliothesque.wordpress.com/2009/12/03/une-retention-tertiaire/) : 

>Quelles prescriptions thérapeutiques des LLM pour les individus ? 
>Comment éviter que nous devenions de simples vérificateurs et que l'IA soit un dealer de connaissance ?
