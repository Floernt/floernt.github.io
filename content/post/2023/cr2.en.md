---
title: CryptoReflexions#2
slug: crypto-report-2
description: Reflections on French legislative developments and the strengthening of PSAN regulation.
date : 2023-01-30
tldr: 
...
It also has the fortune of counting, among its twenty or so unicorns, two active in the sector ([Ledger](https://www.ledger.com/) & [Sorare](https://sorare.com/)) (to qualify as a unicorn, a startup must reach a valuation of one billion dollars without being listed on the stock exchange).
...
Ultimately, the tightening project was not carried through and France is heading toward an enhanced version of the PSAN before being subject, like the rest of Europe, to the [MiCA regulation](https://cryptomonnaie.be/reglement-europeen-crypto/).

For those who want a TL;DR of the enhanced regime: it's [here](https://www.linkedin.com/posts/activity-7023958114064289792-iY8O/).
...
I have already mentioned this in [#CryptoReflexions1](https://open.substack.com/pub/cryptobelgique/p/vie-privee-et-crypto-actifs-le-mariage?r=iyfdo&utm_campaign=post&utm_medium=web) that I wrote and refer you to it for more details.
