---
title : Phenomenology of a Practice with Generative AI (2026)
slug: phenomenology-of-a-practice-with-generative-ai-2026
date : 2026-01-19
...
This text was written as part of an experiment I describe here: [Phenomenological experiment with generative artificial intelligence]({{<relref "/experience phenomenologique.md" >}}).
...
### Prompt Engineering as a Legal Competency
...
This is also why I recommend therapeutic prescriptions for using GAI, such as consulting and reading the sources cited by the machine in order to appropriate them (see on this subject [my note on operational dispossession](https://reflexions.florianernotte.be/post/depossession-operatoire/)).
