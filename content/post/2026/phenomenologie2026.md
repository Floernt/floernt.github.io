...
C'est aussi pour cela que je recommande des prescriptions thérapeutiques à l'utilisation de l'IAG comme notamment consulter et lire les sources citées par la machine pour se les approprier (voir sur le sujet [ma note sur la dépossession opératoire](https://reflexions.florianernotte.be/post/depossession-operatoire/)).
