---
title: Grammatize and observe. New therapeutic practices
slug: grammatize-and-observe
date: 2026-02-24
description: Outline of the imperceptive and therapeutic practices.
tags: 
- ia
- numerique
- dualite
...
Thus, Anders mentions that "public opinion pressure" would prevent us from resisting, from objecting. Today, I believe this "public pressure" is still very much present. This pressure makes collaboration with the machine not only acceptable but desirable. It is now omnipresent in the professional world. Generative artificial intelligence (hereafter GAI) is imposing itself as an obligatory passage. Intellectual professions are being urged to adopt these tools or risk being considered archaic or outdated. A European regulation imposes digital literacy for users (deployers) and providers of AI systems. This *quasi-imperative* is fueled by the dominant discourse that advocates the augmentation of the human by the machine. GAI would enhance our capabilities, free us from repetitive tasks, make us more efficient. This narrative masks a far deeper process: a progressive [dispossession of our operative capacity](/en/glossaire/termes/operative-dispossession/) [that I attempted to explore in this note](https://reflexions.florianernotte.be/post/depossession-operatoire/). I refer the reader to that note for more information. I will simply summarize by stating that in many uses, GAI no longer merely supports reflection. It tends to take charge of reasoning itself, relegating the user to a validation role. The user is no longer the one who thinks and produces: they become the one who triggers a process and verifies its result.

This reconfiguration of the role is a contemporary form of what Bernard Stiegler called [proletarianization](/en/glossaire/termes/proletarianization/). The user's knowledge is not suppressed but it is externalized into a technical system that executes it in their place, and often differently. The locus where reflection takes place migrates from the mind to the device, and as a result, control over this process escapes the user due to [algorithmic opacity](/en/glossaire/termes/algorithmic-opacity/).

## On the [imperceptive](/en/glossaire/termes/the-imperceptive/): a quasi-imperative

I use the term "*quasi-imperative*" because the dynamics of GAI adoption in the professional world deserve closer examination. This "*quasi-imperative*" could be better described using a neologism: an [imperceptive](/en/glossaire/termes/the-imperceptive/), a contraction of *imperative* + *imperceptible*. The [imperceptive](/en/glossaire/termes/the-imperceptive/) is an imperative that one does not perceive as such.
...
In this configuration, the user considers that they are exercising a rational choice: gaining productivity and staying competitive. They feel they are being innovative and modernizing their practice. The decision to adopt GAI appears to them as an act of professional "sovereignty" (to reuse this fashionable and somewhat overused term — see on this topic my note on [digital autonomy](https://reflexions.florianernotte.be/post/autonomie-numerique/)). The approach seems fully voluntary. Formally, it is, but it is no longer so substantively. The environment in which this choice is made is itself constructed to make it inevitable. The alternatives — continuing without the tool, taking time to evaluate its effects, refusing cognitive delegation — are (too) often devalued.
...
As Anders proposes, but with less radicalism, I believe that GAI must be profoundly, sincerely, and truly thought through. It is a complex exercise and not necessarily a passion for everyone. One must find pleasure in ceaselessly questioning this thing that fascinates as much positively as negatively. Despite all these questions, I remain convinced of one thing: GAI, like all technology, is a [*pharmakon*](/en/glossaire/termes/pharmakon/) (a remedy while also being a poison).

The ambivalence inherent in every technology places us permanently in this tension between the "good" and the "bad." [I have already argued here](https://reflexions.florianernotte.be/post/ethique-conformit%C3%A9/) that it is not useful to reject technology wholesale because we would then miss out on interesting opportunities or advantages. I had previously sketched out a few practices that can be qualified as therapeutic. This therapeutic approach is necessary in the face of the [*pharmakon*](/en/glossaire/termes/pharmakon/), and it is a [pharmacology](/en/glossaire/termes/pharmacology/) that we must ceaselessly put into practice. In addition to the four practices previously sketched, I would like to add two new ones.

### [Grammatize](/en/glossaire/termes/grammatization/)

First, [grammatization](/en/glossaire/termes/grammatization/) as resistance to this [dispossession](/en/glossaire/termes/operative-dispossession/).

According to Ars Industrialis,

>grammatization — an expression that extends and diverts a concept from Sylvain Auroux[1](https://web.archive.org/web/20251015025440/https://arsindustrialis.org/grammatisation#sdfootnote1sym) — designates the transformation of a temporal continuum into a spatial discrete: it is a process of description, formalization, and discretization of human behaviors (calculations, languages, and gestures) that enables their reproducibility.
