---
title: Knowing Without Doing. Doing Without Knowing.
slug: operative-dispossession
date: 2026-01-13
...
In early January 2026, I published a note on [the proletarianization of law in the AI era.](https://reflexions.florianernotte.be/post/proletarisation-droit/). Following this, I had some very interesting exchanges with other lawyers that nourished my reflections on the subject.
...
Today, even if technically the LLM does not "know," socially and economically, it is increasingly treated as if it did. Moreover, the image of the stochastic parrot is no longer immediately invoked when discussing LLMs (see for example [here](https://antirez.com/news/157) and [there](https://arxiv.org/html/2505.23323v1)).
...
In a certain way, this observation is relevant. Accessibility is increased, and GAI allows accomplishing a series of things of which we were not necessarily capable (see on the subject: [AI Is a Transformation](https://reflexions.florianernotte.be/post/ia-transformation/)).
...
>Tertiary retentions constitute the milieu in which our secondary retentions operate a selection of our primary retentions. ([Christian Faure](https://www.christian-faure.net/2006/05/10/a-propos-de-la-rtention/))
...
[Chatonsky considered the place of GAI within a new retention: quaternary retention.](https://chatonsky.net/lecture-ecriture/) He describes it as that which bears on attentional gestures and habits themselves.
...
Chatonsky also proposes the concept of [distension](https://chatonsky.net/retention-distention/) to qualify "the statistical processing of retentions" performed by this fourth memory.
...
If we return to the notion of pharmakon ([discussed here](https://reflexions.florianernotte.be/post/ethique-conformit%C3%A9/)), technology being both remedy and poison, we must implement therapeutic practices as Stiegler advocated.

I could reformulate his remarks from [an intervention transcribed here](https://abracadabibliothesque.wordpress.com/2009/12/03/une-retention-tertiaire/):

>What therapeutic prescriptions for LLMs for individuals?
>How to prevent us from becoming mere verifiers and AI from being a knowledge dealer?
...
1. Always produce a first version without AI, even if imperfect, before any solicitation of an LLM.
